  ...
  return (
    <section id="aboutUs" className="py-10 px-4 lg:px-20 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-2">Key Facts</h2>
        ...
        <div className="mb-8">
          ...
          <ul className="list-disc list-inside">
            ...
            <li><strong>2020:</strong> Reached over 100 clients in supplies, installation and support, showcasing trust and reliability in the industry.</li>
        ...
        <div>
          ...
          <p><strong>Email:</strong> <a href="mailto:info@oakitsolutionsandsupplies.com" className="text-blue-500 hover:underline">info@oakitsolutionsandsupplies.com</a></p>
