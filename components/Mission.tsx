      ...
      <div className="container px-4 md:px-6 mt-12">
        <div className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-gray-900 to-gray-950 text-gray-50">
          <div className="container px-4 md:px-6 flex flex-col items-center space-y-4">
            <div className="inline-block rounded-lg bg-gray-100 px-3 py-1 text-black dark:bg-gray-700">Our Mission</div>
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Empowering Businesses Through Technology</h2>
