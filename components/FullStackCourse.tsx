      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 lg:py-16">
        <Reveal>
          <div className="mx-auto max-w-3xl text-center space-y-4">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">Become a full-stack web developer in just 1.5 months.</p>
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-x-6">
              <Button size="lg" variant="secondary" className="btn-glow w-full sm:w-auto">
                <Link href="/fullstack-learn-more">Learn More</Link>
              </Button>
              <Button size="lg" variant="default" className="bg-gradient-to-r from-purple-500 to-blue-500 btn-glow w-full sm:w-auto">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 mt-20">
          <Reveal delay={1}>
            <div className="card-glass rounded-xl p-8 h-full">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Front End Track</h2>
          ...
          <Reveal delay={2}>
            <div className="card-glass rounded-xl p-8 h-full">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Back End Track</h2>
              <p className="mt-4 text-lg leading-8 text-gray-600 dark:text-gray-300">
