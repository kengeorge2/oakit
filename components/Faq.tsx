...
const Faq = () => {
  ...
  return (
    <section className="w-full py-8 md:py-16 lg:py-24 bg-gray-50 dark:bg-gray-900" id="faq">
      <div className="container px-4 md:px-6">
        <div className="space-y-4 text-center mb-12">
          <div className="inline-block rounded-lg bg-gray-200 dark:bg-gray-700 px-3 py-1 text-sm">FAQ</div>
