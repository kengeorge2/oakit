...
const Hero: React.FC = () => {
  return (
    <section className="relative w-full py-16 md:py-28 lg:py-36 xl:py-48 section-dark grid-overlay overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-purple-500/8 blur-[120px] pointer-events-none animate-pulse-glow" />
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] rounded-full bg-blue-500/6 blur-[100px] pointer-events-none" />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center space-y-6 text-center">
          <div className="space-y-4 animate-fade-in-up">
            ...
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl bg-gradient-to-r from-purple-500 via-blue-500 to-lime-500 text-transparent bg-clip-text">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
            ...
            <Link
              ...
              className="inline-flex h-12 items-center justify-center rounded-lg border border-gray-600 bg-white/5 backdrop-blur-sm px-8 py-3 text-sm font-medium text-gray-300 hover:bg-white/10 hover:text-white hover:border-gray-500 transition-all duration-300"
            >
              View Plans
            </Link>
          </div>
