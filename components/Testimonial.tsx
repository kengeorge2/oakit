...
const Testimonial = () => {
  return (
    <section className="w-full py-8 md:py-16 lg:py-24 section-dark grid-overlay" id="testimonials">
      <div className="container px-4 sm:px-6 text-center md:px-6">
        <Reveal>
              ...
              <div className="card-glass rounded-xl p-6 text-left h-full">
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-500/20 dark:to-blue-500/20 border border-gray-200 dark:border-white/[0.1] flex items-center justify-center text-sm font-bold text-purple-600 dark:text-purple-300">
                      {t.initial}
                    </div>
                    <div>
