...
* @see https://v0.dev/t/pmXDgURSWwV
      ...
      <section className="w-full py-8 md:py-16 lg:py-24 bg-gray-100 dark:bg-gray-800" id="blog">
        <div className="container px-4 md:px-6">
          ...
          <div className="mt-12 space-y-4">
            ...
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Flexible Pricing for Your IT Needs</h2>
            <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Monthly/Annual Retainer</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="text-4xl font-bold">$700</div>
                    <p className="text-gray-500 dark:text-gray-400">Includes basic IT support and maintenance.</p>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      Includes comprehensive IT support and management.
                    </p>
                    <div className="flex justify-center">
                      <Button className="w-full">Get Started</Button>
                    </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      Customized IT solutions for enterprise-level businesses.
                    </p>
                    <div className="flex justify-center">
      ...
      <section>
        ...
        <div className="container px-4 md:px-6 mt-12">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <footer className="w-full bg-gray-900 text-gray-50 dark:bg-gray-950 dark:text-gray-50 py-6">
              <div className="container px-4 md:px-6 flex flex-col sm:flex-row items-center justify-between">
                <p className="text-sm">
                  ...
                  <br />
                  OAK IT SOLUTIONS AND SUPPLIES LTD
                  <br />
                  123 Main Street, Oakville, ON L6H 2Z9
                </p>
