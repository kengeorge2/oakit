...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Token handoff from URL (email verification, post-registration)
  ...
  return (
    <AuthContext.Provider value={{ user, token, isLoading, login, logout, isAuthenticated: !!user, fetchUser }}>
      {children}
